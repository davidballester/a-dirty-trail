...
describe('ChallengeRate', () => {
    describe('getWeaponChallengeRate', () => {
        ...
        it('returns the average damage for weapons without ammunition', () => {
            const challengeRate = ChallengeRate.getWeaponChallengeRate(club);
            expect(challengeRate).toEqual(1.5);
        });

        it('returns a lower value for weapons with same damage and ammunition', () => {
            const challengeRate = ChallengeRate.getWeaponChallengeRate(
                revolver
            );
        ...
        it('returns an even lower value for weapons with less ammunition', () => {
            const revolverChallengeRate = ChallengeRate.getWeaponChallengeRate(
                club
            );
            const shotgunChallengeRate = ChallengeRate.getWeaponChallengeRate(
                shotgun
            );
    ...
    describe('getActorChallengeRate', () => {
        ...
        it('returns the expected challenge rate', () => {
            const challengeRate = ChallengeRate.getActorChallengeRate(actor);
